...
export function OnboardingSuccess({ accountType }: OnboardingSuccessProps) {
  ...
  return (
    <div className="space-y-[12px] sm:space-y-[16px] text-center relative px-[16px] sm:px-0">
      ...
      <motion.div
        className="absolute top-[15%] sm:top-[20%] left-[50%] -translate-x-1/2 w-[240px] sm:w-[280px] lg:w-[300px] h-[240px] sm:h-[280px] lg:h-[300px] rounded-full bg-[#10b981]/5 blur-3xl"
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        }}
      ...
      >
        <h1 className="text-[24px] sm:text-[28px] lg:text-[32px] font-semibold text-[#1e3a5f] tracking-tight">
          Profile setup complete! 🎉
        </h1>
        <p className="text-[14px] sm:text-[15px] lg:text-[16px] text-[#6b7280] max-w-[340px] sm:max-w-[380px] lg:max-w-[400px] mx-auto leading-relaxed">
          {isArtisan
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="group w-full sm:w-auto px-[32px] sm:px-[40px] lg:px-[48px] py-[12px] sm:py-[13px] mt-[24px] sm:mt-[32px] lg:mt-[4vh] rounded-[8px] sm:rounded-[10px] font-medium text-[white] font-[500] text-[15px] sm:text-[16px] bg-[#6366f1] hover:bg-[#5558e3] transition-all duration-[200ms] border-[0] cursor-pointer shadow-lg shadow-[#6366f1]/20 hover:shadow-xl hover:shadow-[#6366f1]/30 inline-flex items-center justify-center gap-[8px]"
        >
